...
## Stilrichtlinien
- Verwandle direkte Rede und Ich-Perspektiven in neutrale Aussagen (z. B. „Ich gebe euch ein Beispiel …“ → „Im Folgenden wird ein Beispiel ausgeführt …“).
- Ersetze umgangssprachliche Redewendungen durch sachliche Erläuterungen.
- Behebe offensichtliche Übersetzungs- und Transkriptionsfehler (z. B. „Trader of Entscheidungen“ → „Trade-off-Entscheidungen“).
- Korrigiere inhaltliche Fehler, sofern die fachliche Bedeutung eindeutig ist.
- Entferne Begrüßungen oder Meta-Kommentare zur Vorlesung.
- Fülle fehlende oder unvollständige Textstellen verantwortungsvoll auf Basis des Kontextes.
- Ersetze jeden Vorkommnis des Wortes „Videoeinheit“ durch „Kapitel“.
- Formuliere den Text so, dass er flüssig und kohärent lesbar ist.
